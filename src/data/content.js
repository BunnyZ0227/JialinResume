...
现居北京，希望寻找一个能够贡献我的专业能力并创造积极影响力的团队。`,
  ...
  education: [
    ...
    { cn: '本科 · 北京林业大学 (211) · 2017-2021 · 环境设计专业（景观方向）· 专业前5%', en: 'B.Des. Environmental Design · Beijing Forestry University (211) · 2017-2021 · Top 5%' }
  ]
};
...
export const works = [
  {
    ...
    tags: ['内容策略', 'A/B测试', '全球化'],
    challenge: {
      cn: '字节跳动全球业务极速扩张，产品矩阵覆盖东南亚、北美、中东等文化迥异的市场。传统"一套素材打全球"模式既跟不上产品迭代速度，也无法真正打动本地用户。',
      en: 'ByteDance\'s global business expanded rapidly, with products covering Southeast Asia, North America, Middle East and other diverse markets.'
    },
    approach: {
      cn: '不做单纯的创意供应商，而是成为字节跳动产品团队的"外置创意大脑"。建立可持续的内容策略流水线：深度市场调研 → 三层内容策略 → 月度A/B测试 → 周维度数据复盘优化。',
      en: 'Not just a creative vendor, but an "external creative brain" for ByteDance product teams. Built a sustainable content strategy pipeline.'
    },
    impact: {
      cn: 'US地区多条素材效果达平台均值70+倍。年均管理5万+素材交付，覆盖短视频、AIGC、动效、2D/3D动画、短剧。',
      en: 'Multiple US market creatives achieved 70x platform average performance. Managed 50,000+ asset deliveries annually.'
    }
  },
  {
    id: 'universal',
...
export const experiences = [
  {
    period: '2018 — 至今',
    title: { cn: 'A. 品牌创意策略总监', en: 'A. Creative Strategy Director' },
    ...
    brands: { cn: '合作品牌：字节跳动、DiDi、阿里巴巴、bilibili、腾讯、小红书、Clarins、飞鹤、阿迪达斯、麦当劳等', en: 'Brands: ByteDance, DiDi, Alibaba, bilibili, Tencent, Xiaohongshu, Clarins, Feihe, adidas, McDonald\'s & more' }
  },
  {
    period: '2023 — 2025',
    title: { cn: 'B. 城乡规划师', en: 'B. Urban-Rural Planner' },
  ...
  {
    period: '2022 — 至今',
    title: { cn: 'C. 共创作者', en: 'C. Co-creator' },
...
export const hobbiesContent = {
  ...
  description: {
    cn: '业余时间我有一家水晶网店，也喜欢在摄影和绘画中定格美好。',
...
export const footerContent = {
  ...
  subheading: { cn: '期待与你交流', en: 'Looking forward to connecting' },
  email: 'Jzhang0227@126.com',
  phone: '+86 17600010227'
};
